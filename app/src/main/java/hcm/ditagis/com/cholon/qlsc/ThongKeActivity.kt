...
class ThongKeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val items = timePeriodReport.items
        ...
        this@ThongKeActivity.findViewById<View>(R.id.layout_thongke_thoigian).setOnClickListener { v -> showDialogSelectTime() }
        query(items!![0])
    }
    ...
    private fun showDialogSelectTime() {
        ...
        val finalItems = mThongKeAdapter!!.items
        listView.setOnItemClickListener { parent, view, position, id ->
            ...
            if (itemAtPosition.id == finalItems.size) {
                ...
                layout1.findViewById<View>(R.id.btn_layngaythongke).setOnClickListener { v ->
