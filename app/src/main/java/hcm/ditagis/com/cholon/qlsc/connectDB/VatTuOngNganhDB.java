...
public class VatTuOngNganhDB implements IDB<List<VatTu>, Boolean, String> {
    private Context mContext;

    public VatTuOngNganhDB(Context mContext) {
    ...
    public List<VatTu> find() {
        ...
        try {
            ...
            String query = mContext.getString(R.string.sql_select_vattu_ongnganh);
