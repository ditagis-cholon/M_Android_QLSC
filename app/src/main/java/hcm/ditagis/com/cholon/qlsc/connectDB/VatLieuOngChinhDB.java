...
public class VatLieuOngChinhDB implements IDB<HashMap<Integer, String>, Boolean, String> {
    DateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
    private Context mContext;

    public VatLieuOngChinhDB(Context mContext) {
    ...
    public HashMap<Integer, String> find() {
        ...
        try {
            ...
            String query = mContext.getString(R.string.sql_select_vatlieu_ongchinh);
